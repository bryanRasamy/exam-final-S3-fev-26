...
<body>
    ...
    if (!empty($currentPage)) {
        ...
        $contentPage = "test.php"; // Page par défaut
    }
    ?>
        ...
        <div class="sidebar-section">
            ...
            <nav class="sidebar-nav nav flex-column">
                <a class="nav-link<?= $currentPage === 'liste-produits' ? ' active' : '' ?>" href="/modele?page=liste-produits">
                    <i class="bi bi-basket3"></i> Ajouter un categorie
                </a>
                <a class="nav-link<?= $currentPage === 'statistique' ? ' active' : '' ?>" href="/admin?page=statistique">
                    <i class="bi bi-box-seam"></i> Statistique
                </a>
                <a class="nav-link<?= $currentPage === 'echange' ? ' active' : '' ?>" href="/modele?page=echange">
                    <i class="bi bi-arrow-left-right"></i> Aller au coter client
                </a>
            </nav>
        </div>
